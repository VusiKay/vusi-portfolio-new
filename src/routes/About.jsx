    ...
    return(
        ...
        <div className="about-container">
            ...
            <span>
               ...
               <span className='name-txt'> I’m Katlego Vusimuzi Mthombeni</span><span className='explanation-txt'> — 
...
<div className="my-journey">
            <p className='beyond'>Beyond the Screen.</p>
           
        </div>
        <p className='beyond-the-screen'>When I’m not designing, I’m probably training,
         running, or exploring new places. I believe travel expands creativity, every city, culture, and experience teaches you something new about people and how they interact with the world.

Fitness keeps my mind sharp and focused; travel keeps it open and inspired.
 Together, they remind me that <strong>design is about movement and perspective</strong>, always evolving, always adapting.</p>
            


<div className="my-journey">
            <p className='philosophy'>My Design Philosophy.</p>
